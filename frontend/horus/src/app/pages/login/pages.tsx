...
export default function Login() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-gray-300 relative">
            <form 
            ...
            >
                ...
                <button
                    type="submit"
                    className="w-full bg-cyan-600 text-white font-semibold py-2 rounded-md hover:bg-cyan-700 transition duration-200"
                >
                    Entrar
                </button>
            </form>
